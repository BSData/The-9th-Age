...
<gameSystem id="875f-af88-1503-3e7f" name="Fantasy Battles: The 9th Age" book="The 9th Age - Rules - v1.2" revision="15" battleScribeVersion="2.00" authorName="Arturius &amp; Karanadon" authorContact="arturius@the-ninth-age.com" authorUrl="http://www.the-ninth-age.com" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <profiles/>
  <rules/>
  <infoLinks/>
  <costTypes>
  ...
  <forceEntries>
    ...
    <forceEntry id="dc0f-b12f-1314-f435" name="The Vermin Swarm" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <constraints/>
      <categoryEntries>
        <categoryEntry id="d0e8-af40-96cb-2473" name="Built and Bred" hidden="false">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers>
            <modifier type="decrement" field="e125-d2c8-a027-2583" value="1">
              <repeats>
                <repeat field="points" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="6ef9-f0f6-8731-f2ba" repeats="1"/>
              </repeats>
              <conditions/>
              <conditionGroups/>
            </modifier>
            <modifier type="decrement" field="e125-d2c8-a027-2583" value="1">
              <repeats>
                <repeat field="points" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="2248-7fb9-45bf-e932" repeats="1"/>
              </repeats>
              <conditions/>
              <conditionGroups/>
            </modifier>
          ...
          <constraints>
            <constraint field="limit::points" scope="roster" value="30.0" percentValue="true" shared="false" includeChildSelections="true" includeChildForces="true" id="e125-d2c8-a027-2583" type="max"/>
          </constraints>
        </categoryEntry>
        <categoryEntry id="6ef9-f0f6-8731-f2ba" name="Character + Built and Bred" hidden="false">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        ...
        <categoryEntry id="2248-7fb9-45bf-e932" name="Tunnel Gunners + Built and Bred" hidden="false">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        ...
        <categoryEntry id="f83a-168d-2372-373a" name="Special" hidden="false">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        ...
        <categoryEntry id="0f89-86fd-d997-bc42" name="Characters" hidden="false">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers>
            <modifier type="decrement" field="9525-b822-4453-7753" value="1">
              <repeats>
                <repeat field="points" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="6ef9-f0f6-8731-f2ba" repeats="1"/>
              </repeats>
              <conditions/>
          ...
          <constraints>
            <constraint field="limit::points" scope="roster" value="35.0" percentValue="true" shared="false" includeChildSelections="true" includeChildForces="true" id="9525-b822-4453-7753" type="max"/>
          </constraints>
        </categoryEntry>
        <categoryEntry id="ac64-260f-86bc-9fd5" name="Core" hidden="false">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
          <constraints>
            <constraint field="limit::points" scope="roster" value="25.0" percentValue="true" shared="false" includeChildSelections="true" includeChildForces="false" id="0c39-da50-8bc8-0d89" type="min"/>
          </constraints>
        </categoryEntry>
        <categoryEntry id="b3cb-1403-a49d-8a5f" name="Tunnel Gunners" hidden="false">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers>
            <modifier type="decrement" field="f4cb-8855-f028-c036" value="1">
              <repeats>
                <repeat field="points" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="2248-7fb9-45bf-e932" repeats="1"/>
              </repeats>
              <conditions/>
          ...
          <constraints>
            <constraint field="limit::points" scope="roster" value="30.0" percentValue="true" shared="false" includeChildSelections="true" includeChildForces="true" id="f4cb-8855-f028-c036" type="max"/>
          </constraints>
        </categoryEntry>
      </categoryEntries>
      <forceEntries/>
